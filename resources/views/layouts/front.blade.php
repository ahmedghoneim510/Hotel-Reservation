    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col d-flex align-items-center">
                <p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+201004054291</a> or <span class="mailus">email us:</span> <a href="#">ahmedghoneim510@email.com</a></p>
            </div>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                @if(auth()->check())
                    <li class="nav-item"><a href="{{route('user.booking')}}" class="nav-link">View Booking</a></li>
                    <li class="nav-item"><a href="#" class="nav-link">{{auth()->user()->name}}</a></li>
                    <li class="nav-item">
                        <a href="#" onclick="submitForm('logoutForm');" class="nav-link">
                            Logout
                        </a>
