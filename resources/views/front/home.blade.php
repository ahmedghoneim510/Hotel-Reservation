                ...
                <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
                    <div class="d-block services-wrap text-center">
                        ...
                        <div class="media-body py-4 px-3">
                            ...
                            <p><a href="{{route('hotel',$hotel->id)}}" class="btn btn-primary">View rooms</a></p>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <section class="ftco-section bg-light">
        <div class="container-fluid px-md-0">
            ...
            <div class="row no-gutters">
                <?php  $right=true; $check=0;?>
                @foreach($apartments as $apartment)
                <div class="col-lg-6">
                    <div class="room-wrap d-md-flex">
                        <a href="{{route('hotel.room',$apartment->id)}}" class="img" style="background-image: url({{$apartment->image_url}});"></a>
                        <div class="half left-arrow d-flex align-items-center">
                            <div class="text p-4 p-xl-5 text-center">
                                ...
                                <ul class="list-accomodation">
                                    <li><span>Hotel Name:</span> {{$apartment->hotel->name}} </li>
                                    ...
                                    <li><span>Price:</span> {{$apartment->price}} $</li>
                                </ul>
