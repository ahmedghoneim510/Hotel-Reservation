    ...
    <section class="ftco-section ftco-book ftco-no-pt ftco-no-pb">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-lg-4">
                    <form action="{{route('hotel.room.booking',$room->id)}}" method="post" class="appointment-form" style="margin-top: -568px;">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-wrap">
                                        ...
                                        <input type="date" id="check_in" name="check_in" class="form-control" placeholder="MM/DD/YYYY" value="{{ old('check_in') }}"></div>
                                </div>
                                @error('check_in')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="check_out" name="check_out" class="form-control" placeholder="MM/DD/YYYY" value="{{ old('check_out') }}"></div>
                                </div>
                                @error('check_out')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
